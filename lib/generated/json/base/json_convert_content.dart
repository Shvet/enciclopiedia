...
class JsonConvert<T> {
  ...
  static M _getListChildType<M>(List data) {
    if (<CategorySubEntity>[] is M) {
      return data.map<CategorySubEntity>((e) => CategorySubEntity().fromJson(e)).toList() as M;
    } else if (<CategorySubParams>[] is M) {
      return data.map<CategorySubParams>((e) => CategorySubParams().fromJson(e)).toList() as M;
      ...
      return data.map<SearchPagination>((e) => SearchPagination().fromJson(e)).toList() as M;
    } else if (<CategoryMainEntity>[] is M) {
      return data.map<CategoryMainEntity>((e) => CategoryMainEntity().fromJson(e)).toList() as M;
    } else if (<CategoryMainSub>[] is M) {
      return data.map<CategoryMainSub>((e) => CategoryMainSub().fromJson(e)).toList() as M;
    }
